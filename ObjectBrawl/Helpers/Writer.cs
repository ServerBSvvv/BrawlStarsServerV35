...
namespace ObjectBrawl.Helpers
{
    public static class Writer
    {
        ...
        public static async Task WriteBool(this Stream stream, bool value)
        {
            await Task.Run(() => { stream.WriteByte((byte)(value ? 1 : 0)); });
        }
        ...
        public static async Task WriteScId(this Stream stream, int ClassId, int InstanceId)
        {
            await stream.WriteVInt(ClassId);
            await stream.WriteVInt(InstanceId);
        }

        public static async Task WriteVInt64(this Stream stream, long value)
        {
